(function(root) {
  ...
  var Game = Slader.Game = function(view, audio) {
    ...
    this.view.setStartListener(this.startGame.bind(this));
  ...
  Game.prototype.step = function(time) {
    ...
    if (!this.gameOver) {
      ...
      this.view.setRestartListener(this.resetGame.bind(this));
