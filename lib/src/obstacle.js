(function(root) {
  ...
  var Obstacle = Slader.Obstacle = function(view, vel) {
    var randObs = Math.floor(Math.random() * 1);
    switch (randObs) {
      case 0:
        Obstacle.createEgg(this, view);
        break;
      case 1:
        Obstacle.createGlasses(view);
        break;
      case 2:
        Obstacle.createHouse(view);
        break;
      case 3:
        Obstacle.createIceCream(view);
        break;
      case 4:
        Obstacle.createLog(view);
        break;
      case 5:
        Obstacle.createPencil(view);
        break;
      case 6:
        Obstacle.createShip(view);
        break;
      case 7:
        Obstacle.createShoe(view);
        break;
      case 8:
        Obstacle.createTooth(view);
        break;
      case 9:
        Obstacle.createWorm(view);
        break;
    }
