(function(root) {
  ...
  var Subject = Slader.Subject = function(view) {
    ...
    can.addEventListener("touchstart", this.addTouchVelocity.bind(this));
    can.addEventListener("touchend", this.removeTouchVelocity.bind(this));
  };
